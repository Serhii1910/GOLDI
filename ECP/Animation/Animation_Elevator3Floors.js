...
Animation.prototype.InitializeBlinkingActuatorSVGObjects = function() {
    ...
    let Snap_Floor1DoorLeftOpen     = this.CreateNewSVGRect(this.SVGCanvas, this.Snap_Door1Left , this.DoorOpenPositionLeft    + this.CageOffsetX);
    let Snap_Floor1DoorLeftClosed   = this.CreateNewSVGRect(this.SVGCanvas, this.Snap_Door1Left , this.DoorClosedPositionLeft  + this.CageOffsetX);
    let Snap_Floor1DoorRightOpen    = this.CreateNewSVGRect(this.SVGCanvas, this.Snap_Door1Right, this.DoorOpenPositionRight   + this.CageOffsetX);
    let Snap_Floor1DoorRightClosed  = this.CreateNewSVGRect(this.SVGCanvas, this.Snap_Door1Right, this.DoorClosedPositionRight + this.CageOffsetX);
    let Snap_Floor2DoorLeftOpen     = this.CreateNewSVGRect(this.SVGCanvas, this.Snap_Door2Left , this.DoorOpenPositionLeft    + this.CageOffsetX);
    let Snap_Floor2DoorLeftClosed   = this.CreateNewSVGRect(this.SVGCanvas, this.Snap_Door2Left , this.DoorClosedPositionLeft  + this.CageOffsetX);
    let Snap_Floor2DoorRightOpen    = this.CreateNewSVGRect(this.SVGCanvas, this.Snap_Door2Right, this.DoorOpenPositionRight   + this.CageOffsetX);
    let Snap_Floor2DoorRightClosed  = this.CreateNewSVGRect(this.SVGCanvas, this.Snap_Door2Right, this.DoorClosedPositionRight + this.CageOffsetX);
    let Snap_Floor3DoorLeftOpen     = this.CreateNewSVGRect(this.SVGCanvas, this.Snap_Door3Left , this.DoorOpenPositionLeft    + this.CageOffsetX);
    let Snap_Floor3DoorLeftClosed   = this.CreateNewSVGRect(this.SVGCanvas, this.Snap_Door3Left , this.DoorClosedPositionLeft  + this.CageOffsetX);
    let Snap_Floor3DoorRightOpen    = this.CreateNewSVGRect(this.SVGCanvas, this.Snap_Door3Right, this.DoorOpenPositionRight   + this.CageOffsetX);
    let Snap_Floor3DoorRightClosed  = this.CreateNewSVGRect(this.SVGCanvas, this.Snap_Door3Right, this.DoorClosedPositionRight + this.CageOffsetX);
...
Animation.prototype.InitializeSensorSVGObjects = function() {
    ...
    let Animation = this;
    $.each([20, 21, 22], function (index, value) {
...
Animation.prototype.Refresh = function() {
    // Cage position
    if(this.Sensors[ 0]) this.Snap_Elevator.transform("translate("+this.CageOffsetX+"," + this.ElevatorCagePositionFloor1         + ")");
    if(this.Sensors[ 1]) this.Snap_Elevator.transform("translate("+this.CageOffsetX+"," + this.ElevatorCagePositionFloor2         + ")");
    if(this.Sensors[ 2]) this.Snap_Elevator.transform("translate("+this.CageOffsetX+"," + this.ElevatorCagePositionFloor3         + ")");
    if(this.Sensors[ 3]) this.Snap_Elevator.transform("translate("+this.CageOffsetX+"," + this.ElevatorCagePositionAboveFloor1    + ")");
    if(this.Sensors[ 4]) this.Snap_Elevator.transform("translate("+this.CageOffsetX+"," + this.ElevatorCagePositionBelowFloor2    + ")");
    if(this.Sensors[ 5]) this.Snap_Elevator.transform("translate("+this.CageOffsetX+"," + this.ElevatorCagePositionAboveFloor2    + ")");
    if(this.Sensors[ 6]) this.Snap_Elevator.transform("translate("+this.CageOffsetX+"," + this.ElevatorCagePositionBelowFloor3    + ")");
