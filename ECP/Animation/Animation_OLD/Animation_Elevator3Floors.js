function Animation(EventHandler, SettingsParameter, CallBack) {
    ...
    var DoorOpenPositionLeft = -22;
    var DoorClosedPositionLeft = 10.5;
    var DoorMiddlePositionLeft = -5;
    var DoorOpenPositionRight = 80;
    var DoorClosedPositionRight = 48.5;
    var DoorMiddlePositionRight = 64;
    ...
    function initialize() 
    {
		...
		$("#" + SettingsParameter.AnimationDIVName).load('ECP/Animation/Images/Image_Elevator3Floors.svg', function ()
        {
            SVG = $('#SVGAnimation');
    ...
    function Refresh() 
    {
        ...
        if (Actuators[18]) EC_LED_Floor1_Color.attr("fill", "#cfcf00");//"#17DF81");
        else EC_LED_Floor1_Color.attr("fill", "#006837");
        
        if (Actuators[19]) EC_LED_Floor2_Color.attr("fill", "#cfcf00");//"#17DF81");
        else EC_LED_Floor2_Color.attr("fill", "#006837");
        
        if (Actuators[20]) EC_LED_Floor3_Color.attr("fill", "#cfcf00");//"#17DF81");
