...
RichCalendar.get_iframe_styles = function () {
    ...
    for (i = 0; i < sheets_num; i++) {
        if (RichCalendar.is_ie) {
            ...
            if (/RichCalendar.css$/.test(styles[i].href)) {
...
// tmp of text data in various languages
...
//		}
    ...
    // store this calendar in tmp of active calendars
...
// return tmp with keys - weekend days
