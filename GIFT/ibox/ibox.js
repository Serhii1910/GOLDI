...
var iBox = function() {
		...
		reposition: function() {
			...
			if (active.dimensions) {
				...
				if (active.params.can_resize) {
					...
					var width2;
					if (document.documentElement.clientWidth/2 < 733) {
						width2 = '733px';
					} else {
						width2 = (document.documentElement.clientWidth/2) + 'px';
					}
					var height2;
					if (els.footer.innerHTML=='About') {
						height2 = '500px';
					} else {
						height2 = '80%';
					}
					_pub.updateObject(els.wrapper.style, {width: width2, height: height2});
				}
				...
				els.content.style.height = 'calc(100% - 40px)';
				els.content.style.backgroundColor = '#2c3e50';
	...
	var drawCSS = function() {
		...
		var default_skin = "#ibox_footer_wrapper {font-weight:bold;height:20px;line-height:20px;} #ibox_footer_wrapper a {text-decoration:none;background:#888;border:1px solid #666;line-height:16px;padding:0 5px;color:#333;font-weight:bold;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif, cursive;font-size:10px;} #ibox_footer_wrapper a:hover {background-color:#bbb;color:#111;} #ibox_footer_wrapper {font-size:15px;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;color:#111;} #ibox_wrapper {border:1px solid #ccc;} #ibox_wrapper {background-color:#999;}#ibox_content {background-color:#eee;border:1px solid #666;} #ibox_loading {padding:50px; background:#000;color:#fff;font-size:16px;font-weight:bold;}";
	...
	var initialize = function() {
		...
		_pub.fireEvent('load');
		$(function() {
			$( "#ibox_wrapper" ).resizable({
					handles: "se, sw, s, e, w"
			});
			$( "#ibox_wrapper" ).draggable();
		});
	};
