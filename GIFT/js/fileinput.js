...
(function fileinput($) {
    ...
    var isIE = function (ver) {
        ...
        defaultFileTypeSettings = {
            ...
            text: function (vType, vName) {
                return (vType !== undefined && vType.match('text.*')) || vName.match(/\.(gift|txt|md|gift|csv|nfo|php|ini)$/i);
            },
    ...
    FileInput.prototype = {
        ...
        listen: function () {
            ...
            self.$container.find('.kv-fileinput-upload').off('click').on('click', function (e) {
                $('#L_load_machine_model').modal('hide');
                handleFileSelect('L_load_machine_file_upload');
        ...
        clear: function () {
            var self = this, cap;
            document.getElementById('fileinput_browser_button').classList.remove('hide');
            self.$btnUpload.removeAttr('disabled');
        ...
        change: function (e) {
            document.getElementById('fileinput_browser_button').classList.add('hide');
            $('#fileinput_cancel_button').click(function() {
                self.clear();
            });
        ...
        renderBrowse: function () {
            ...
            return '<div id="fileinput_browser_button" class="' + css + '"' + status + '> ' + self.browseIcon + '<span class="mobileOut">' + self.browseLabel + '</span>' + ' </div>';
        },
        renderRemove: function () {
            ...
            return '<button type="button" title="' + self.removeTitle + '" class="' + css + '"' + status + '>' + self.removeIcon + '<span class="mobileOut2">' + self.removeLabel  + '</span>' + '</button>';
        },
        renderCancel: function () {
            ...
            return '<button type="button" title="' + self.cancelTitle + '" class="' + css + '">' + self.cancelIcon + self.cancelLabel + '</button>';
        },
        renderUpload: function () {
            ...
            if (!self.isUploadable || self.isDisabled) {
                content = '<button type="submit" title="' + self.uploadTitle + '"class="' + css + '"' + status + '>' + self.uploadIcon  + '<span class="mobileOut2">' + self.uploadLabel  + '</span>' +  '</button>';
            } else {
    ...
    $.fn.fileinput.defaults = {
        ...
        uploadClass: 'btn btn-primary btn-default',
        uploadUrl: null,
        uploadAsync: true,
        uploadExtraData: {},
        maxFileSize: 0,
    ...
    $.fn.fileinputLocales.en = {
        fileSingle: 'Datei',
        filePlural: 'Dateien',
        browseLabel: '<span data-i18n="upload.select"></span>',
        removeLabel: 'L&ouml;schen',
        removeTitle: 'Ausgew&auml;hlte l&ouml;schen',
        cancelLabel: 'Laden',
        cancelTitle: 'Hochladen abbrechen',
        uploadLabel: '<span data-i18n="upload.upload"></span>',
        uploadTitle: 'Hochladen der ausgew&auml;hlten Dateien',
        msgSizeTooLarge: 'Datei "{name}" (<b>{size} KB</b>) überschreitet maximal zul&auml;ssige Upload-Gr&ouml;ße von <b>{maxSize} KB</b>.',
