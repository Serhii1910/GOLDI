...
//COMPOUND COMPONENTS ARE LOADED FROM A STATIC LIBRARY NOW! (found in the assets folder)
...
simcir.registerDevice('HalfAdder',
{
  ...
  "devices":[
    ...
    {"type":"In","id":"dev4","x":144,"y":32,"label":"X"},
    {"type":"In","id":"dev5","x":144,"y":80,"label":"Y"},
...
simcir.registerDevice('FullAdder',
{
  ...
  "devices":[
    ...
    {"type":"In","id":"dev1","x":120,"y":80,"label":"X"},
    {"type":"In","id":"dev2","x":120,"y":128,"label":"Y"},
...
simcir.registerDevice('2to4BinaryDecoder',
{
  ...
  "devices":[
    ...
    {"type":"In","id":"dev7","x":128,"y":48,"label":"A"},
    {"type":"In","id":"dev8","x":128,"y":96,"label":"B"},
    {"type":"Toggle","id":"dev9","x":80,"y":48,"label":"Toggle"},
    {"type":"Toggle","id":"dev10","x":80,"y":96,"label":"Toggle"},
    {"type":"DC","id":"dev11","x":32,"y":96,"label":"DC"},
    {"type":"Out","id":"dev12","x":328,"y":24,"label":"0"},
    {"type":"Out","id":"dev13","x":328,"y":72,"label":"1"},
    {"type":"Out","id":"dev14","x":328,"y":120,"label":"2"},
    {"type":"Out","id":"dev15","x":328,"y":168,"label":"3"},
...
simcir.registerDevice('3to8BinaryDecoder',
{
  ...
  "devices":[
    {"type":"In","id":"dev0","x":24,"y":144,"label":"A"},
    {"type":"In","id":"dev1","x":24,"y":192,"label":"B"},
    {"type":"In","id":"dev2","x":24,"y":240,"label":"C"},
    ...
    {"type":"Out","id":"dev9","x":296,"y":32,"label":"0"},
    {"type":"Out","id":"dev10","x":296,"y":80,"label":"1"},
    {"type":"Out","id":"dev11","x":296,"y":128,"label":"2"},
    {"type":"Out","id":"dev12","x":296,"y":176,"label":"3"},
    {"type":"Out","id":"dev13","x":296,"y":224,"label":"4"},
    {"type":"Out","id":"dev14","x":296,"y":272,"label":"5"},
    {"type":"Out","id":"dev15","x":296,"y":320,"label":"6"},
    {"type":"Out","id":"dev16","x":296,"y":368,"label":"7"}
  ],
  "connectors":[
...
simcir.registerDevice('4to16BinaryDecoder',
{
  ...
  "devices":[
    {"type":"In","id":"dev0","x":32,"y":56,"label":"A"},
    {"type":"In","id":"dev1","x":32,"y":104,"label":"B"},
    {"type":"In","id":"dev2","x":32,"y":152,"label":"C"},
    {"type":"In","id":"dev3","x":32,"y":200,"label":"D"},
