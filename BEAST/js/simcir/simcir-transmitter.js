...
!function($, $s) {
    ...
    return function(device) {
      ...
      device.createUI = function() {
        ...
        var updateState = function() {
          const ishot = out1.getValue() === 1;
          $path.toggleClass("beast-connection-hot", ishot && showConnectorState);
          $path.toggleClass("beast-connection-cold", !ishot&& showConnectorState);
          $point.toggleClass("beast-connection-hot", ishot && showConnectorState);
          $point.toggleClass("beast-connection-cold", !ishot && showConnectorState);
        }
        ...
        device.$ui.on('mouseover', function(event) {
          ...
          out1.$ui.on("nodeValueChange", () => updateState());
  ...
  BeastController.registerDefaultComponent(new BasicComponent('Transmitter', 'Transmitter', createTransmitterFactory()));
