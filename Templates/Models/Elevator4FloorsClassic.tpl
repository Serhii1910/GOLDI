...
<h1 class="tag" data-i18n="Elevator4FloorsClassic"></h1>
...
<div class="text-justify">
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <p>
                <span class="tag" data-i18n="ModelElevatorC4Floors1"></span>
        ...
        <div class="col-md-3">
            ...
            <img src="Images/Examples/Elevator_C.jpg" alt="" width="80%">
