<input hidden class="i18next_modules" value="PSPU_Elevator4Floors">

<h1 class="tag" data-i18n="Elevator4Floors"></h1>
...
<div class="text-justify">
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <p>
				<span class="tag" data-i18n="ModelElevatorB4Floors1"></span>
			

                <br><br>
                <a href="Downloads/Handout_Elevator4floor.pdf"><strong class="tag"data-i18n="PDFWithPinout"></strong><span
        ...
        <div class="col-md-3">
            ...
            <img src="Images/Examples/Elevator_4_Floors.png" alt="" width="80%">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <table class="table table-condensed table-bordered table-hover table-striped">
                ...
                <th colspan="3" class="tag"data-i18n="OuputsActuators"></th>
                <tr>
                    <th class="tag" data-i18n="Variable"></th>
                    <th class="tag" data-i18n="Name"></th>
                    <th class="tag" data-i18n="Direction"></th>
