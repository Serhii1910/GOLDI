...
-->
<input hidden class="i18next_modules" value="PSPU_Warehouse">

<h1 class="tag" data-i18n="Warehouse"></h1>
...
<div class="text-justify">
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <p>
                <span class="tag" data-i18n="ModelWarehouse1"></span>

                <br><br>
                <a href="Downloads/Handout_Storage_Warehouse.pdf"><strong class="tag" data-i18n="PDFWithPinout"></strong><span
        ...
        <div class="col-md-3">
            ...
            <img src="Images/Examples/Storage_Warehouse.png" alt="" width="80%">
