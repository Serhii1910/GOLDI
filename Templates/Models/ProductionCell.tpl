...
-->
<input hidden class="i18next_modules" value="PSPU_ProductionCell">

<h1 class="tag" data-i18n="ProductionCell"></h1>
...
<div class="text-justify">
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <p>
                <span class="tag" data-i18n="ModelProductionCell1"></span>

                <br><br>
                <a href="Downloads/Handout_ProductionCell.pdf"><strong class="tag" data-i18n="PDFWithPinout"></strong><span
        ...
        <div class="col-md-3">
            ...
            <img src="Images/Examples/Production_Cell.png" alt="" width="80%">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <img src="Images/Examples/SchematicProductioncell.png" class="center-block" alt="Schematic Production Cell" width="70%">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <p>
                <!--In diesem Beispiel 
                <br><br>
                <a href="Images/Examples/3_Axis_Portal_Example(FPGA).zip"><strong>Beispiel Code FPGA </strong><span
                        class="glyphicon glyphicon-cloud-download" aria-hidden="true"></span></a>
                <br><br>
                <a href="Images/Examples/3_Axis_Portal_Example(uC).zip"><strong>Beispiel Code uC </strong><span
                        class="glyphicon glyphicon-cloud-download" aria-hidden="true"></span></a>
                <br><br>
				-->
